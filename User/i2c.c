...
uint8_t I2C_Read(uint8_t DEVICE_WRITE_ADDRESS, uint8_t RegAddr, uint8_t *Data)
{
	...
	I2C_Send7bitAddress(I2C_x, DEVICE_WRITE_ADDRESS+1, I2C_Direction_Receiver);
	...
	if((timeout--) == 0) return 0xf4;
         ...
         i = I2C_ReceiveData(I2C_x);
        
         //I2C_NACKPositionConfig(I2C_x, I2C_NACKPosition_Current);
