...
{ 												
  ...
  GPIO_PinAFConfig(Open_USART3_TX_GPIO_PORT, Open_USART3_TX_SOURCE, Open_USART3_TX_AF);
  GPIO_PinAFConfig(Open_USART3_RX_GPIO_PORT, Open_USART3_RX_SOURCE, Open_USART3_RX_AF);
...
void USART3_SendChar( uint8_t ch )
{
  ...
  USART_SendData(Open_USART3, (uint8_t) temp);

  /* Loop until the end of transmission */
  while (USART_GetFlagStatus(Open_USART3, USART_FLAG_TC) == RESET)
  {}
